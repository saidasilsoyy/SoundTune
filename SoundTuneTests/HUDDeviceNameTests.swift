// SoundTuneTests/HUDDeviceNameTests.swift
...
struct TahoeStyleHUDNameFontTests {
    ...
    @Test("nameFont equals the system 13pt medium rounded font (rowNameBold token)")
    func nameFontIsRowNameBold() {
        #expect(TahoeStyleHUD.nameFont == .system(size: 13, weight: .medium, design: .rounded))
