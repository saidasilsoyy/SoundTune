// SoundTuneTests/ShortcutsRegistryTests.swift
import Testing
import Foundation
import AppKit
...
struct ShortcutsRegistryTests {
    ...
    func supportsRepeatFlag() {
        ...
        #expect(ShortcutAction.openSettings.supportsRepeat == false)
    }
    ...
    func nameStable() {
        ...
        #expect(registry.name(for: .openSettings).rawValue == "open-settings")
    ...
    private func makeIsolatedSettings() -> SettingsManager {
        let dir = FileManager.default.temporaryDirectory.appendingPathComponent("SoundTuneTests-\(UUID().uuidString)")
