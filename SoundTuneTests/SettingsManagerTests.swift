// SoundTuneTests/SettingsManagerTests.swift
...
struct SettingsJSONTests {
    ...
    func populatedRoundTrip() throws {
        ...
        original.deviceEQSettings = [
            "device-uid-123": EQSettings(bandGains: [1, 0, -1, 0, 2, 0, -2, 0, 1, 0], isEnabled: true)
        ]
        ...
        #expect(decoded.deviceEQSettings == original.deviceEQSettings)
    ...
    func emptyJSONDefaults() throws {
        ...
        #expect(decoded.deviceEQSettings.isEmpty)
