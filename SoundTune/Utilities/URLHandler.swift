// SoundTune/Utilities/URLHandler.swift
import Foundation
import os
...
/// Handles URL scheme actions for SoundTune (soundtune://...)
@MainActor
final class URLHandler {
    private let audioEngine: any URLHandlerEngine
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "SoundTune", category: "URLHandler")
    ...
    func handleURL(_ url: URL) {
        ...
        guard url.scheme == "soundtune" else {
    ...
    /// URL format: soundtune://set-volumes?app=com.a&volume=100&app=com.b&volume=50
    ...
    /// URL format: soundtune://step-volume?app=com.a&direction=up (or down)
    ...
    /// URL format: soundtune://set-mute?app=com.a&muted=true&app=com.b&muted=false
    ...
    /// URL format: soundtune://toggle-mute?app=com.a&app=com.b
    ...
    /// URL format: soundtune://set-device?app=com.a&device=<deviceUID>
    ...
    /// URL format: soundtune://reset?app=com.a&app=com.b or soundtune://reset (all apps)
