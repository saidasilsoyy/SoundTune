// SoundTune/Audio/Keys/MediaKeyMonitor.swift
import AppKit
import AudioToolbox
import CoreGraphics
import os
...
final class MediaKeyMonitor {
    ...
    private let logger = Logger(subsystem: "com.soundtune.SoundTune", category: "MediaKeyMonitor")
    ...
    /// can flash the current device's transport symbol. Wired by SoundTuneApp after init.
