// SoundTune/Views/DesignSystem/DesignTokens.swift
import SwiftUI
import AppKit

/// Design System tokens for SoundTune UI
...
enum DesignTokens {
    ...
    enum Typography {
        /// Section header text (e.g., "Output Devices") - prominent and medium rounded
        static let sectionHeader = Font.system(size: 12, weight: .medium, design: .rounded)

        /// Section header letter spacing (reduced tracking for standard sentence/title case)
        static let sectionHeaderTracking: CGFloat = 0.5

        /// App/device name in rows
        static let rowName = Font.system(size: 13, weight: .regular, design: .rounded)

        /// Medium variant for default device name
        static let rowNameBold = Font.system(size: 13, weight: .medium, design: .rounded)

        /// Volume percentage display
        static let percentage = Font.system(size: 11, weight: .regular, design: .monospaced)

        /// Small caption text
        static let caption = Font.system(size: 10, weight: .regular, design: .rounded)

        /// Device picker text
        static let pickerText = Font.system(size: 11, weight: .regular, design: .rounded)

        /// EQ frequency labels
        static let eqLabel = Font.system(size: 9, weight: .regular, design: .monospaced)

        /// AutoEQ card profile name
        static let cardProfileName = Font.system(size: 12, weight: .medium, design: .rounded)

        /// AutoEQ card source/measuredBy
        static let cardSource = Font.system(size: 9, weight: .regular, design: .rounded)

        /// Settings card header (sentence case, 13pt medium rounded)
        static let cardHeader = Font.system(size: 13, weight: .medium, design: .rounded)

        /// Settings row description (11pt regular, tertiary)
        static let rowDescription = Font.system(size: 11, weight: .regular, design: .rounded)
    }
    ...
    enum Links {
        ...
        static let project = URL(string: "https://soundtune.app")!

        /// Project license in the personal fork.
        static let license = URL(string: "https://soundtune.app/license")!
    }
}
