// SoundTune/Views/Components/EQPanelView.swift
import SwiftUI
...
struct EQPanelView: View {
    ...
    private var saveButton: some View {
        ...
        .buttonStyle(.plain)
        .help(t("Save current EQ as preset"))
        .accessibilityLabel(t("Save current EQ curve as a new preset"))
    }
    ...
    private var savePresetField: some View {
        HStack(spacing: DesignTokens.Spacing.xs) {
            TextField(t("Preset name"), text: $savePresetName)
            ...
            .help(t("Save preset"))
            .accessibilityLabel(t("Confirm save preset"))
            ...
            .buttonStyle(.plain)
            .help(t("Cancel"))
            .accessibilityLabel(t("Cancel saving preset"))
        }
    ...
    private var renameButton: some View {
        ...
        .buttonStyle(.plain)
        .help(t("Rename preset"))
        .accessibilityLabel(t("Rename current preset"))
    }
    ...
    private var renamePresetField: some View {
        HStack(spacing: DesignTokens.Spacing.xs) {
            TextField(t("Preset name"), text: $renamePresetName)
                .textFieldStyle(.plain)
                .font(.system(size: 11, weight: .medium))
            ...
            .help(t("Confirm rename"))
            .accessibilityLabel(t("Confirm rename preset"))
            ...
            .buttonStyle(.plain)
            .help(t("Cancel"))
            .accessibilityLabel(t("Cancel renaming preset"))
        }
        .padding(.horizontal, DesignTokens.Spacing.sm)
        .padding(.vertical, 4)
        .background {
