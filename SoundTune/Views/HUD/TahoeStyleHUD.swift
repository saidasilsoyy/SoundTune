// SoundTune/Views/HUD/TahoeStyleHUD.swift
import SwiftUI
...
struct TahoeStyleHUD: View {
    ...
    private var accessibilityDescription: String {
        ...
        if displayMute {
            return String(format: t("%@, muted, volume at %d percent"), device, percent)
        }
        return String(format: t("%@, volume %d percent"), device, percent)
    }
